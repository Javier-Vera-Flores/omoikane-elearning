 ...
 * @author aczay
 */
public class EstrategiaAvanzada implements EstrategiaDeAprendizaje {
     @Override
    public RutaAprendizaje calcularRuta(Progreso progreso) {
        System.out.println("Estrategia Avanzada: Generando ruta de aprendizaje con IA simulada...");
